...
class ObrasSociales(models.Model):
    id_obras_sociales = models.BigIntegerField(primary_key=True)
...
class PacienteXOs(models.Model):
    ...
    id_pacient = models.ForeignKey('Pacientes', models.DO_NOTHING, db_column='id_pacient', blank=True, null=True)
    ...
    es_titular = models.IntegerField(blank=True, null=True)
...
class Pacientes(models.Model):
    id_pacientes = models.BigIntegerField(primary_key=True)
...
class Turnos(models.Model):
    id_turnos = models.BigIntegerField(primary_key=True)
    id_paci = models.ForeignKey(Pacientes, models.DO_NOTHING, db_column='id_paci', blank=True, null=True)
