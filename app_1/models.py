...
class ObrasSociales(models.Model):
    ...
    os_codigo = models.CharField(max_length=45)
    os_nombre = models.CharField(max_length=45)
...
class PacienteXOs(models.Model):
    id_paciente_x_os = models.BigAutoField(primary_key=True)
    id_paciente = models.ForeignKey('Pacientes', models.DO_NOTHING, db_column='id_paciente')
    id_obra_social = models.ForeignKey(ObrasSociales, models.DO_NOTHING, db_column='id_obra_social')
    nro_afiliado = models.CharField(max_length=45)
    es_titular = models.IntegerField(db_column='es-titular')  # Field renamed to remove unsuitable characters.
...
class Turnos(models.Model):
    ...
    estado_turno = models.CharField(max_length=45)
